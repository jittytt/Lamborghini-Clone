...
import {incrementProductQuantity, decrementProductQuantity, removeProduct} from './viewcart-product-controller.js';
            ...
            <div class="cart-item">
                ...
                <div class="wishlist-delete-icons-container">
                    <span class="MuiIconButton-label">
                        <svg width="27" height="25" fill="gray" xmlns="http://www.w3.org/2000/svg" class="favourites-icon" focusable="false" viewBox="0 0 27 25" aria-hidden="true">
